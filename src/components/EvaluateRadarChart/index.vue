...
const props = defineProps<{ indicator: []; data1: []; data2: [] }>();
...
<template>
  <div class="evaluateRadarChart card relative h-full min-h-300">
    ...
    <span class="comment_count self absolute left-20 top-95 text-(primary-b)"
      >评价数: 999</span
    >
    <span class="comment_count opposite absolute right-20 top-95 text-error"
      >评价数: 199</span
    >
    <span class="absolute bottom-30 left-20 text-little"
      >单位：%（百分比）</span
    >
  </div>
</template>
