...
<template>
  ...
  <div class="card table-main">
    ...
    <!-- 表格主体 -->
    <el-table v-bind="$attrs" :id="uuid" ref="tableRef" :data="processTableData" :border="border" :row-key="rowKey"
    ...
    <slot name="pagination">
      <Pagination v-if="pagination" :pageable="pageable" :handle-size-change="handleSizeChange"
        :handle-current-change="handleCurrentChange" v-bind="paginationOptions" />
    </slot>
  </div>
  <!-- 列设置 -->
